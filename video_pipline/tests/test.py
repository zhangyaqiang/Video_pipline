...
def pipline(video):
    ...
    subprocess.Popen(('mv',
                     video,
                     '/home/zyq/video_pipline_data/hxla_finished'),
...
if __name__ == "__main__":
    src_video_dir = '/home/zyq/video_pipline_data/hxla2016'
    shots_root_dir = '/home/zyq/video_pipline_data/hxla_shots'
    video_list = glob.glob(os.path.join(src_video_dir, '201609*.mp4'))

    for video in video_list:
        pipline(video)
    # video = '/home/zyq/video_pipline_data/hxla2016/20160201.mp4'
    # pipline(video)
