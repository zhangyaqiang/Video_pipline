...
def pipline(video):
    ...
    subprocess.Popen(('mv',
                      video,
                      '/home/zyq/video_pipline_data/test/finished'),
...
if __name__ == "__main__":
    src_video_dir = '/home/zyq/video_pipline_data/test/src'
    shots_root_dir = '/home/zyq/video_pipline_data/test/shots'
    video_list = glob.glob(os.path.join(src_video_dir, '*.mp4'))

    for video in video_list:
        pipline(video)
    # video = '/home/zyq/video_pipline_data/test/src/20171205.mp4'
    # pipline(video)
